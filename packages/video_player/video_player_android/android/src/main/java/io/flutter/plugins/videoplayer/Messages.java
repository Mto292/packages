...
public class Messages {
    ...
    public interface AndroidVideoPlayerApi {
        ...
        void setTextTrack(Long textureId, String language);

        String getSupportTracks(@NonNull TextureMessage msg);
        ...
        static void setup(
            ...
            }
            {
                BasicMessageChannel<Object> channel =
                        new BasicMessageChannel<>(
                                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.getSupportTracks", getCodec());
                if (api != null) {
                    channel.setMessageHandler(
                            (message, reply) -> {
                                ArrayList<Object> wrapped = new ArrayList<Object>();
                                ...
                                TextureMessage msgArg = (TextureMessage) args.get(0);
                                try {
                                    String output = api.getSupportTracks(msgArg);
                                    wrapped.add(0, output);
                                } catch (Throwable exception) {
                                    ArrayList<Object> wrappedError = wrapError(exception);
                                    wrapped = wrappedError;
            ...
            }
            {
                BasicMessageChannel<Object> channel =
                        new BasicMessageChannel<>(
                                binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setTextTrack", getCodec());
                if (api != null) {
                    channel.setMessageHandler(
                            (message, reply) -> {
                                System.out.print("SetTrackData::");
                                System.out.print("SetTrackData" + message);
                                ArrayList<Object> wrapped = new ArrayList<Object>();
                                ArrayList<Object> args = (ArrayList<Object>) message;
                                int textureId = (int) args.get(0);
                                String language = (String) args.get(1);
                                try {
                                    api.setTextTrack((long) textureId, language);
                                    wrapped.add(0, null);
                                } catch (Throwable exception) {
                                    ArrayList<Object> wrappedError = wrapError(exception);
                                    wrapped = wrappedError;
