...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
    ...
    @Override
    public void setTextTrack(Long textureId, String language) {
        VideoPlayer player = videoPlayers.get(textureId);
        player.setTextTrack(language);
    }

    @Override
    public String getSupportTracks(@NonNull TextureMessage arg) {
        VideoPlayer player = videoPlayers.get(arg.getTextureId());
        return player.getSupportTracks();
    }
